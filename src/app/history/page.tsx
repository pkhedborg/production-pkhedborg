...
const History = () => {
  ...
  return (
    <div className="history-page w-full">
      ...
      <section className="relative h-[60vh] md:h-screen w-screen -ml-[50vw] left-[50%]">
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              { value: 105000000, text: "history.grantsDistributed", decimal: 2 },
      ...
      <div className="w-screen -ml-[50vw] left-[50%] relative bg-gray-100">
